		...
		<div className='flex flex-col flex-grow rounded-md border border-gray-100 bg-white cursor-pointer hover:shadow-md hover:border-opacity-0 transform hover:-translate-y-1 transition-all duration-200'>
			...
			<div className='box-border px-5 pb-5 '>
				...
				{cartProductCount(id) >= 1 ? (
					<div className='flex bg-[#009e7f] w-full h-9 text-white text-base font-bold justify-between items-center flex-shrink-0 rounded'>
					...
					<button className='group w-full focus:border-none  h-9 rounded cursor-pointer border-0 flex items-center hover:bg-[#019376] border-green-700 bg-gray-100 hover:text-white overflow-hidden trasition-all duration-75 ease-in-out'>
						<p className='text-xs flex-grow'>Add</p>
						<span
							onClick={() => cartObject()}
							className='px-2 h-9 bg-gray-200 flex items-center transition-all hover:text-white duration-75 ease-in-out group-hover:bg-[#009e7f]'>
